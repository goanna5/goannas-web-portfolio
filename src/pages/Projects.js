  ...
  useEffect(() => {
    ...
    <MDBRow>
        ...
        <MDBCol lg={4} md={12} className='mb-4 mb-lg-0'>
          ...
          <h3>Discord bot</h3>
          <p>All functionality is basically just identifying key words in messages - my GitHub repo has more details on that :)</p>
          <a href="https://github.com/goanna5/discord-bot" className="hyperlinks">Github Repo</a>
        </MDBCol>
